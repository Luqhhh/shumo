...
每日冻结条件下，情景采购比点预测基准节省1\,262\,236.91元（7.3466\%）。初始合同费增加99.6359万元，实际紧急费减少225.8596万元。
允许调整条件下，情景采购比点预测基准节省463\,192.69元（2.9194\%）。初始合同费增加93.2931万元，实际紧急费减少124.3479万元，调整费另减少15.2645万元。
