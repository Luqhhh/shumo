...
- `src/microgrid/problem/contracts.py` 已建立 TimeGrid / BatteryState / BatteryAction / InfoSet / PurchasePlan / CostBreakdown 等领域 contract；这些 contract 按团队提供的 pre-division 语义实现，共享四项 D_TIME_INTERNAL / D_EFF / D_STATE / D_INFO 已于 2026-09-10 经用户批准；其余 decisions 仍为 pending/proposed。
